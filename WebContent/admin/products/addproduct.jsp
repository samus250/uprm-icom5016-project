...
<div class="center_content">
	...
	<h1>
		<center>Welcome to Machete DB Enterprise</center>
	</h1>
	...
	<center>
		<form name="add" action="/ICOM5016_Project/addProduct" method="post">
			Product name:
			...
			<br>Product Photo: 
			<input type="file" class="file_1" name="photo" />
			<br>
